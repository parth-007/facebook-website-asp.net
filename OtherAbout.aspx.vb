...
Partial Class aboutde
 ...
 sql1 = "select userid from Users where email='" & Session("xyz") & "'"
            sql2 = "select fname from Users where email='" & Session("xyz") & "'"
            sql3 = "select surname from Users where email='" & Session("xyz") & "'"
            sql4 = "select phone from Users where email='" & Session("xyz") & "'"
            sql5 = "select email from Users where email='" & Session("xyz") & "'"
            sql6 = "select day from Users where email='" & Session("xyz") & "'"
            sql7 = "select name from Months where Id in(select month from Users where email='" & Session("xyz") & "')"
            sql8 = "select year from Users where email='" & Session("xyz") & "'"
            sql9 = "select gender from Users where email='" & Session("xyz") & "'"
            sql10 = "select sname from State where stateid in(select stateid from Users where email='" & Session("xyz") & "')"
            sql11 = "select cname from City where cityid in (select cityid from Users where email='" & Session("xyz") & "')"
            sql12 = "select scname from School where schoolid in(select schoolid from Users where email='" & Session("xyz") & "')"
            sql13 = "select colname from College where colid in(select colid from Users where email='" & Session("xyz") & "')"
